...
def insert_data_into_database(log_data):
    ...
    sql = "INSERT INTO treater_101_2 (id, date_of_log, author, pressure, temperature, front_water_level, back_water_level, flame_condition, shift, month, day, year, remark, date, time) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
    val = (log_data)    
...
def get_log_data(content):
    ...
    # get Pressure
    pressure = get_pressure(content)
    log_data.append(pressure)
    print("Pressure: " + str(pressure))
    #get Temperature
    temperature = get_temperature(content)
    log_data.append(temperature)
    print("Temperature: " + str(temperature))
    #get Front Water Level
    front_water_level = get_front_water_level(content)
    log_data.append(front_water_level)
    print("Front Water Level: " + str(front_water_level))
    #get Back Water Level
    back_water_level = get_back_water_level(content)
    log_data.append(back_water_level)
    print("Back Water Level: " + str(back_water_level))
    #get Flame Condition
...
def main():        
    folder_of_folders_path = '../database-insertion/ELOG/Pembina North/Treater 101 2'
    process_folder_of_folders_of_files(folder_of_folders_path)
    #process_file('../database-insertion/ELOG/Pembina North/Treater 101 2/2024/240626a.log')
